# Goal of `agentic-tdd`
I want to build a multi-agent Test-Driven Development (TDD) CLI tool (`agentic-tdd`) that is able to develop a code kata, utilizing a user-supplied kata description and goal. The final outcome, after a given amount of TDD steps, should be a codebase containing the code kata.
